                    ...
                    switch (_anomalies findIf {_x isEqualTo _type}) do {
                        ...
                        case 5: {
                            [localize "STR_anomaly_fog", [
                                    ...
                                    ["CHECKBOX", localize "STR_anomaly_fog_effect_only", [false]]
                                ],
                                {
                                    params ["_dialog", "_args"];
                                    _dialog params ["_radius", "_rectangle", "_color", "_effectOnly"];
                                    _args params ["_pos"];
                                    [QGVAR(createAnomaly), [[_pos, _radius, _rectangle, 0, _color, _effectOnly], "fog"]] call CBA_fnc_serverEvent;
                                }, {}, [_pos]
                            ] call zen_dialog_fnc_create;
                        };
    ...
    [localize "STR_anomaly_category", localize "STR_anomaly_zeus_start_stop_blowout",
        {
            if (missionNamespace getVariable [QGVAR(blowoutInProgress), false]) then {
                ...
                [localize "STR_anomaly_zeus_start_blowout", [
                        ...
                        ["CHECKBOX", [localize "STR_anomaly_zeus_start_blowout_psy_wave", localize "STR_anomaly_zeus_start_blowout_psy_wave_desc"], [true]]
                    ],
                    {
                        params ["_dialog"];
                        _dialog params ["_time", "_direction", "_useSirens", "_onlyPlayers", "_isLethal", "_environmentParticleEffects", "_psyWave"];
                        [QGVAR(startBlowout), [floor _time, floor _direction, _useSirens, _onlyPlayers, _isLethal, _environmentParticleEffects, _psyWave]] call CBA_fnc_serverEvent;
