...
[_source, "active"] remoteExec ["anomalyEffect_fnc_fruitPunch"];
{
    if(_x isKindOf "Man") then {
        ...
        if(!isNil "ace_medical_fnc_addDamageToUnit") then {
            ...
            [_x, _dam, selectRandom ["leg_l", "leg_r"], "stab", _x] remoteExec ["ace_medical_fnc_addDamageToUnit", _x];
        } else {
...
}, [_trg, _source], 0.5] call CBA_fnc_waitAndExecute;